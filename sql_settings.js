...
default:
    [{
        ...
        [],
        script: [{
            "sql_settings.js": "https://cdn.jsdelivr.net/gh/cchfm1100/website@main/sql_settings.js"
        }],
    },
    ],
    user: [{
        style: [],
        script: [{
            "sql_user.js": "https://cdn.jsdelivr.net/gh/cchfm1100/website@main/sql_user.js"
        }],
    },
    ],
    apps: [{
        style: [],
        script: [{
            "sql_datepicker.js": "https://cdn.jsdelivr.net/gh/cchfm1100/website@main/sql_datepicker.js"
        }],
    },
    ],
    map: [{
        style: [],
        script: [{
            "sql_map.js": "https://cdn.jsdelivr.net/gh/cchfm1100/website@main/sql_map.js"
        }],
    },
    ],
    stories: [{
        style: [],
        script: [{
            "sql_stories.js": "https://cdn.jsdelivr.net/gh/cchfm1100/website@main/sql_stories.js"
        }],
    },
    ],
    feeds: [{
        style: [],
        script: [{
            "1100.sqlite": "1100.sqlite"
        },
        {
            "909090.sqlite": "909090.sqlite"
        },
        {
            "909091.sqlite": "909091.sqlite"
        },
        {
            "909092.sqlite": "909092.sqlite"
        }],
    },
    ],
},
